...
function EditUserForm({user}){
    ...
    return(
        ...
        <div>
          <h2>Edit A User</h2>
          <TextField fullWidth label="Edit name" value={name}
           onChange={(event)=> setName(event.target.value)}
          type="text" 
          placeholder="edit name" /><br></br>
       <br></br>

{/* <TextField fullWidth label="Edit Status" value={status}
...
fetch(`https://63650a617b209ece0f558d28.mockapi.io/userdata/${user.id}`,
{method: "PUT",
